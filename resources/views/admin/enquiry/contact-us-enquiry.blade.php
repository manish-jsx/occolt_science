            ...
            <div class="container-fluid">
                ...
                <div class="row">
                                            ...
                                            <tbody>
                                                @if (!empty($contactus))
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->email }}</td>
                                                        <td>{{ $item->message }}</td>
                                                        <td><a href="{{ route('admin.enquiry.deleteconatactus-enquiry', $item->id) }}"><i class="far fa-trash-alt"></i></a>
                                                        </td>
                                                    </tr> 
                                                    @endforeach
                                                @endif
                                ...
                                <div class="row">
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination justify-content-end">
                                            @if ($contactus->onFirstPage())
                                                <li class="page-item disabled">
                                                    <a class="page-link" href="javascript:void(0);">Previous</a>
                                                </li>
                                            @else
                                                <li class="page-item">
                                                    <a class="page-link" href="{{ $contactus->previousPageUrl() }}">Previous</a>
                                                </li>
                                            @endif
                                            ...
                                            @if ($contactus->hasMorePages())
                                                <li class="page-item">
                                                    <a class="page-link" href="{{ $contactus->nextPageUrl() }}">Next</a>
                                                </li>
                                            @else
                                                <li class="page-item disabled">
                    ...
                    <div class="row d-flex justify-content-end mb-lg-4">
                        <a href="{{ route('admin.enquiry.contactus.enquiry.export') }}" class="btn btn-primary d-inline-block me-lg-3" style="width: auto">
                            <i class="far fa-file-excel"></i> Download Data in Excel
                        </a>
                        {{-- <button type="submit" class="btn btn-primary d-inline-block me-lg-3" style="width: auto"> <i
                                class="far fa-file-excel"></i> Download Data in Excel</button> --}}
