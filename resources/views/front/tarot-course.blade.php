...
@section('section')
    ...
    <section class="inrbnr certiMainPage pt-50 pb-50"
        style="background-image: url({{ asset('front') }}/assets/img/bgs/bg-tarot-course.jpg);">
                ...
                <div class="col-md-7">
                    <div class="inrbnrContent">
                        <div class="inrbnrtext">
                            <h1>Most Trusted Tarot Card Course​</h1>
                            <h1 style="font-size: 22px;">Be a Professional Tarot Reader</h1>
                            <div class="certibnrDesc">
                                <p class="text-justify">
                                    A Tarot card reading course is a kind of cartomancy whereby specialists use cards
                                    purportedly to procure information into the past, present, or future. They define an
                                    inquiry, then, at that point draw cards decipher them for this end. Tarot is a bunch
                                    of cards and the reading of these cards is alluded to as tarot card reading. A Tarot
                                    card reading course can help you have a blissful life by uncovering to you every one
                                    of the inward insider facts of life.
                                </p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label class="form-group">
                                                    ...
                                                    <input type="hidden" name="cource_name" value="Tarot" id="">
                        ...
                        <div class="column">
                            <div class="widget-wrap">
                                <div class="widget-heading">
                                    <h2>ALL INDIA INSTITUTE OF OCCULT SCIENCE</h5>
                                </div>
                                ...
                                <div class="widget-heading">
                                    <h2>CERTIFICATION OF SPECIALIZATION <br>IN MASTER IN TAROT</h2>
                                </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="aboutSideContentsWrapper" style="margin:0px ;">
                        <div class="aboutSideContents">
                            <div class="aboutSide">
                                <h2 class="coursesh2">Begin Your Tarot Card reading journey today with All India Institute of Occult
                                    Science and Earn Most Valuable Certificate.</h2>
                                <h2 class="mt-3 coursesh2">Predict Accurately</h2>
                                <div class="aboutParagraph aboutParagraphmo">
                                    <p>
                                        All India Institute of Occult Science is popularly known for teaching
                                        predictions to their students. The institute aims not just only teaching the
                                        syllabus but also on how to implement.
                                    </p>
                                </div>
                                <h2 class="coursesh2">Experienced Faculty:</h2>
                                <div class="aboutParagraph aboutParagraphmo">
                                    <p>
                                ...
                                <div class="aboutParagraph aboutParagraphmo">
                                    <p>
                                        Enroll in the All India Institute of Occult Science Tarot course and Earn
                                        Valuable Certification. Interactive Learning Environment, Engage in live
                                        discussions, participate in group discussions, and connect with your classmates
                                ...
                                <div class="aboutParagraph aboutParagraphmo">
                                    ...
                                    <p>Enroll in the All India Institute of Occult Science Tarot course and <strong>Earn
                                            Valuable Certification.</strong>
                                    </p>
                                </div>
                                <!-- <h2 class="coursesh2">Continued Support:</h5>
                    ...
                    <div class="aboutSideWrapper forresponsive">
                        <div class="aboutImg position-relative ">
                            <span class="aboutMainImg">
                                <img src="{{ asset('front') }}/assets/img/other/tarot-img-01.jpg" alt="tarot course" class="">
                            </span>
                ...
                <div class="col-md-6">
                    ...
                    <div class="whyChooseCardWrap">
                        <div class="whyqoutline">
                            <p>
                                Are you ready to dive into the mystical world of tarot? Our tarot course is a great to
                                start! It is an in-depth exploration into the world of tarot, providing an opportunity
                                to learn the basics and to delve deeper into its secrets. We provide a comprehensive
                                understanding of tarot, including its history, symbolism, and interpretation. This
                                course is designed to help you gain a better understanding of the cards and how to use
                                them for personal and spiritual development. Our experienced instructors will provide
                                guidance and support as you progress through the course. With our tarot course, you will
                                gain the skills and knowledge to use the cards for insight and guidance into your life.
                            </p>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
    ...
    <section class="methodofTeaching pt-50 pb-50 ">
        <div class="site-width">
            <div class="titleSection ">
                <div class="text-center">
                    <h2>
                        Methods Of Teaching <span>Tarot</span>
                    </h2>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-4 wow animate__zoomIn" style="visibility: visible; animation-name: zoomIn;">
                        <div class="productListCard actionsCard">
                            <div class="prListCard">
                                <div class="prCardImg">
                                    <img src="{{ asset('front') }}/assets/img/bgs/tarotMethod1.png" alt="SHUFFLE and piles method">
                                </div>
                                <div class="prCardContent">
                                    <div class="prCCWrap">
                                        <h2 class="prListh2">SHUFFLE And Piles Method</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row whyRowContainer align-item-center">
                <div class="col-md-6">
                    <div class="aboutSideWrapper forresponsive">
                        <div class="aboutImg position-relative ">
                            <span class="aboutMainImg">
                                <img src="{{ asset('front') }}/assets/img/other/astro-img3.webp" alt="tarot course" class="">
                            </span>
                        </div>
            ...
            <div class="row whyRowContainer col-reverse">
                <div class="col-md-6">
                    <div class="aboutSideWrapper forresponsive">
                        <div class="aboutImg position-relative ">
                            <span class="aboutMainImg">
                                <img src="{{ asset('front') }}/assets/img/other/astro-img2.webp" alt="tarot course" class="">
                            </span>
                        </div>
            ...
            <div class="titleSection withbg2 text-center mb-4">
                <div class="">
                    <h2>
                        ...
                        Benefits of Joining Best Tarot Card Course in
                    </h2>
            ...
            <div class="row whyRowContainer">
                ...
                <div class="col-md-6">
                    ...
                    <div class="FAQsWrapper">
                        <div class="FAQsWrapperCard">
                            <div class="question">
                                Why should I Learn Tarot from AIIOS?
                            </div>
                            <div class="answercont">
                                <div class="answer">
                                    <p>
                        ...
                        <div class="FAQsWrapperCard">
                            ...
                            <div class="answercont">
                                <div class="answer">
                                    <p>The eligibility criteria for enrolling in tarot Course is 10th pass.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="FAQsWrapperCard">
                            <div class="question">
                                ...
                                Can I earn just after completing my Tarot Course?
                            </div>
                            <div class="answercont">
                                <div class="answer">
                                    <p>
                        ...
                        <div class="FAQsWrapperCard">
                            <div class="question">
                                ...
                                How many levels our there in Tarot Course and Time Duration?


                            </div>
                            <div class="answercont">
                                <div class="answer">
                                    <p>Diploma in Tarot 2 Month</p>
                        ...
                        <div class="FAQsWrapperCard">
                            <div class="question">
                                What will be the benefits of doing Tarot Course?
                            </div>
                            <div class="answercont">
                                <div class="answer">
                                    <ul class="normalList">
                                        <li>You will Definitely Learn more than the Syllabus</li>
                                        <li>You will be a Professional Tarot Card Reader</li>
                                        <li>You will be able to give accurate Past, Present, and Future Predictions
                                            without knowing the DOB of your client</li>
                ...
                You will be able to give Vedic Remedies and Solutions, etc..
                        ...
                        <div class="FAQsWrapperCard">
                            <div class="question">
                                What can you do after completing Tarot Course?
                            </div>
                            <div class="answercont">
                                <div class="answer">
                                    <ul class="normalList">
                                        <li>You can take it as a Profession</li>
                                        <li>You will be a certified Tarot Reader</li>
                                        <li>You can predict accurately</li>
                                        <li>You can become a certified Tarot Teacher</li>
        ...
        <div class="site-width">
            <div class="liveClassHomeWrapper">
                                    ...
                                    <div class="row align-item-center">
                                        <div class="col-md-6 order-lg-2">
                                            <div class="aboutSideWrapper forresponsive">
                                                <div class="aboutImg position-relative ">
                                                    <span class="aboutMainImg">
                                                        <img src="{{ asset('front') }}/assets/img/other/tarot_img-02.jpg" alt="tarot course" class="">
                                                    </span>
                                                </div>
                ...
                19TH OF MAY (SUNDAY) 2:00 PM - 4:00 PM
                                                ...
                                                <p>
                                                    A Tarot card reading is a kind of cartomancy whereby specialists use
                                                    cards purportedly to procure information into the past, present, or
                                                    future. They define an inquiry, then, at that point draw cards
                                                    decipher them for this end.
                                                </p>

                                                <p>The cards of the major arcana allude to spiritual matters and
                                                    significant patterns in the examiner’s life. In the minor arcana,
                                                    wands manage business matters and career desires, cups with
                                                    adoration, swords with struggle, and coins with cash and material
                                                    comfort.</p>

                                                <p>The standard modern tarot cards depend on the Venetian or the
                                                    Piedmontese tarot. It contains 78 cards segregated into two social
                                                    events: the major arcana, which has 22 cards, regardless, called
                                                    outperforms, and the minor arcana, which has 56 cards.</p>
                                    ...
                                    <div class="collapse" id="collapseExample">
                                        <div class="card card-body vastu_content_more_deatil vastu_content_drop">
                                            <h3 class="mb-2 text-md-start h3normaltitle">How Tarot Card Work?</h2>
                                            <p>The symbolism in the cards permits you to take advantage of your psyche
                                                brain and instinct immediately. You will figure out how to roll out
                                                significant improvements presently to show your objectives and wants in
                                                the future from this situation of internal strength and information.
                                            </p>

                                            <p>The reading of the cards will give a few answers that can direct your
                                                possible game-plan later on.</p>

                                            <h3 class="text-md-start h3normaltitle">Benefits</h2>
                                            <div class="whyUsWrapper">
                                                <p>Tarot card reading gets rid of all <a href="https://en.wikipedia.org/wiki/Negative_energy" class="text-primary" target="_blank"> pessimistic energy</a> and fills an
                                                    individual with positive energy to instigate him to face challenges.
                                                    It can help make and sustain agreeable associations with others and
                                                    helps in facing challenges</p>
                                                <ul class="normalList">
                                                    <li> it is a magnificent chance to begin a new life. it is perusing
                                                        analyzes those parts of your character that need supporting and
                                                        hence assists you with improving personally.</li>

                                                    <li>In case you are among the individuals who continue to consider
                                                        their negatives and battles as opposed to partaking in some sure
                                                        things then tarot card reading is ideal for you. It assists you
                                                        with discovering internal harmony by conquering sensations of
                                                        nervousness, dread, and stress.</li>


                                                    <li>Regardless of how effective you are, there is consistently an
                                                        opportunity to get better. A card reading is an optimal method
                                                        of picking the regions required for development and dealing with
                                                        them to look for flawlessness.</li>

                                                    <li>In case there is one thing that can assist you with giving bits
                                                        of knowledge in your life and give a superior lucidity level
                                                        then that thing is a tarot card reading.</li>
                                                </ul>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="aboutSideContentsWrapper">
                        <div class="aboutSideContents">
                            <div class="aboutSide">
                                <h5>Want to Enroll in Tarot Course</h5>
                                <h2>
                            ...
                            <div class="row align-item-center col-reverse">
                                <div class="col-md-3">
                                    <div class=" position-relative ">
                                        <img src="{{ asset('front') }}/assets/img/other/addmission-course-img.png" alt="tarot course" class="">
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    ...
                                    <div class="prCardContent">
                                        <div class="prCCWrap">
                                            <h4>
                                                Get Enroll in our tarot card Course & Start your Career as a Certified
